...
def index():
    ...
    # Get the HTML script and div components for our layout
    script, div = components(layout)

    # Also inject Bokeh's CDN links so that BokehJS is actually loaded
    bokeh_resources = CDN.render()

    return render_template(
        "index.html",
        bokeh_resources=bokeh_resources,  # the Bokeh CDN links
        script=script,
        div=div,
