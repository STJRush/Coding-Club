...
<html>
  ...
  <body class="bg-gray-100 text-gray-800 p-4">
    <div class="max-w-3xl mx-auto bg-white shadow-lg p-6 rounded-lg fade-in">
      <!-- Centered container for image and titles -->
      <div class="text-center">
        <!-- The gif image, ensuring it's centered with mx-auto -->
        <img
          src="{{ url_for('static', filename='power.gif') }}"
          alt="Power"
          class="mx-auto mb-4"
        />

        <!-- Large Title and Subtitle -->
        <h1 class="text-4xl font-bold mb-2">Muratocracy : More knowledge, more votes</h1>
        <h2 class="text-lg text-gray-600 mb-6 italic">Democracy without truth is idiocracy</h2>
      </div>
      ...
      {% if user %}
        ...
        {% if user.role == 'admin' %}
          <a
            class="inline-block bg-blue-500 text-white px-4 py-2 mt-4 rounded btn-animate"
